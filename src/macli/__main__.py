...
""")
    ...
    q.add_argument("--region", default=None, metavar="REGION",
                   help="server 自动重登后恢复到的默认 region，例如 cn-north-9")
    q.add_argument("--workspace", default=None, metavar="NAME",
                   help="server 自动重登后恢复到的默认 workspace 名称，例如 SAI2")
    q.add_argument("--workspace-id", dest="workspace_id", default=None, metavar="ID",
                   help="server 自动重登后恢复到的默认 workspace ID")
